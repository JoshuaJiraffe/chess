...
public class EscapeSequences {
    ...
    public static final String RESET_TEXT = RESET_TEXT_BLINKING + SET_TEXT_COLOR_WHITE + RESET_TEXT_ITALIC + RESET_TEXT_UNDERLINE + RESET_TEXT_BOLD_FAINT;
    public static final String RESET_ALL = RESET_TEXT + RESET_BG_COLOR;
